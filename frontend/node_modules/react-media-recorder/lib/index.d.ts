 ...
 */
export declare type PreferCurrentTab = true | false;
...
export declare function useReactMediaRecorder({ audio, video, selfBrowserSurface, preferCurrentTab, onStop, onStart, blobPropertyBag, screen, mediaRecorderOptions, customMediaStream, stopStreamsOnStop, askPermissionOnMount, }: ReactMediaRecorderHookProps): ReactMediaRecorderRenderProps;
